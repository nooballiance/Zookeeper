...
var Binding = (function () {
    ...
    Binding.prototype.bind = function (name, proto) {
        if (this.lib._nbind_value) {
...
function initAsm(binding, callback) {
    ...
    var runtimeInitialized = lib.onRuntimeInitialized;
    lib.onRuntimeInitialized = function () {
        if (runtimeInitialized)
            runtimeInitialized.apply(this, arguments);
        try {
